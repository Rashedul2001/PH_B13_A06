...
const Banner = () => {
    return (
        <div className='p-5 flex flex-col lg:flex-row container mx-auto  my-10 lg:my-16 lg:gap-8 gap-4'>
            <div className='flex-3 space-y-4 '>
                ...
                <div className="items-center flex gap-4">
                    <button className='blue-to-purple-linear p-3 rounded-full text-white font-bold'>Explore Products</button>
                    <button className="inline-flex p-3 border border-purple-500 text-purple-500 rounded-full font-bold "><img src={playIcon} alt="Play" className="mr-2" /> Watch Demo</button>
                </div>
            </div>
