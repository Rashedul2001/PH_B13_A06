    ...
    return (
        <nav className='flex justify-around items-center h-12 '>
            <div className='flex items-center gap-2'>
                ...
                <a className="font-bold cursor-pointer text-3xl blue-to-purple-linear bg-clip-text text-transparent">DigiTools</a>
            ...
            <div className='space-x-4 flex items-center'>
                ...
                <button className="blue-to-purple-linear py-1 px-3  rounded-full font-semibold whitespace-nowrap text-white cursor-pointer" >Get Started</button>
            </div>
